...
<section class="measurements-slider-wrapper">
  <div class="measurements-slider-profile-transform">
    ...
    <p class="add-your-measurements-p">
      Add Your Measurements for Women-Jackets-
    </p>
  ...
  <div class="swiper-container mySwiper">
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
        ...
        <div class="swiper-slide">
          <div class="body-pic" style='background-image: url(<?= MEASUREMENTS_URL;?>public/images/08/4-women_halfback.jpg);width: 50%;
    height: 100%;
    background-size: contain;
    background-repeat: no-repeat;
    background-position: right;'>
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
              <p style="margin: 0;font-weight: bold;">
                Instruction for measuring Women half Back
              </p>
              <p style="margin: 0;">
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
        ...
        <div class="swiper-slide">
          <div class="body-pic" style='background-image: url(<?= MEASUREMENTS_URL;?>public/images/08/5-women_hips.jpg);width: 50%;
    height: 100%;
    background-size: contain;
    background-repeat: no-repeat;
    background-position: right;'>
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
              <p style="margin: 0;font-weight: bold;">
                Instruction for measuring Women Hips
              </p>
              <p style="margin: 0;">
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
        ...
        <div class="swiper-slide">
          <div class="body-pic" style='background-image: url(<?= MEASUREMENTS_URL;?>public/images/08/11-women_jacketlength.jpg);width: 50%;
    height: 100%;
    background-size: contain;
    background-repeat: no-repeat;
    background-position: right;'>
    ...
    transform: translateY(-50%);font-size: 12px;padding: 4px 7px;border: 1px solid #ccc;">
              <p style="margin: 0;font-weight: bold;">
                Instruction for measuring Women Jacket Length
              </p>
              <p style="margin: 0;">
